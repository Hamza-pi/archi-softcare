...
export const EvvFaqs: FAQ[] = [
  ...
  {
    question: "Does your mobile app include electronic signature?",
    answer:
  ...
  {
    question: "Can caregivers see their schedule on the mobile app?",
    answer:
  ...
  },
  {
    ...
    answer: "FREE for home care registries using our software platform.",
  },
  {
    question: "Do caregivers need to have a schedule to clock in + out?",
    answer:
      "No, caregivers can clock in and out at anytime and it does not require that they have a scheduled or assigned visit.",
  },
  {
    question:
      "Can your mobile app and telephony system integrate with other software?",
    answer:
